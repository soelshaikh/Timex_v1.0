    ...
    const options = {
      ...
      handler: async function (response) {
        ...
        const result = await axios.post(
          `http://localhost:5000/paymentverification/${id}`,
          data,
          {
            headers: headers,
                ...
                <div class="breadcrumb-nav breadcrumb-nav-color--black breadcrumb-nav-hover-color--golden">
                  <nav aria-label="breadcrumb">
                    <ul>
                      ...
                      <li>
                        <NavLink to={"/cart/address"}>Address</NavLink>
                      </li>
              ...
              <div className="col-lg-6 col-md-6">
                <form action="#">
                  ...
                  <div className="row">
                    <div class="">
                      <label class="card">
                        <span class="plan-details">
                          ...
                          <span>
                            {addressData?.streetAddress},{addressData?.landmark}
                            ,{addressData?.city},{addressData?.state},
                            {addressData?.pinocde} <span class="slash"> -</span>
                            {addressData?.pincode}
                          </span>
                    ...
                    <div className="order_button pt-3"></div>
                  </div>
                </form>
              </div>
              <div className="col-lg-6 col-md-6">
                      ...
                      <tfoot>
                        <tr>
                          {coupanName === "" ? (
                            ...
                            <>
                              <th>
                                Coupan Discount<span> ({coupanName})</span>
                              </th>
                              <td>
                                <strong>
                                  {Math.round(-CoupanDiscountPrice)}
                                </strong>
                              </td>
                            </>
                          )}
                        ...
                        <tr>
                          {wbalance > 0 ? (
                            <>
                              ...
                              <td>
                                <strong>{Math.round(-wbalance)}</strong>
                              </td>
                            </>
                          ) : (
                            ""
                        ...
                        <tr className="order_total">
                          <th>Order Total</th>
                          <td>
                            <strong>{Math.round(totalAmountlocation)}</strong>
                          </td>
                        </tr>
                      </tfoot>
                    </table>
