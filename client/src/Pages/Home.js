...
onSlideChange={() => console.log('slide change')}> */}
          ...
          >
            <SwiperSlide>
              <NavLink to={"/shop"}>
                <img
                  src="https://www.titan.co.in/dw/image/v2/BKDD_PRD/on/demandware.static/-/Library-Sites-TitanSharedLibrary/default/dwc35babb8/images/homepage/All_Banners/IB_D_310124.jpg"
            ...
            <SwiperSlide>
              <NavLink to={"/shop"}>
                <img
                  src="https://www.titan.co.in/dw/image/v2/BKDD_PRD/on/demandware.static/-/Library-Sites-TitanSharedLibrary/default/dw6bf24990/images/homepage/RagaWatches_D.jpg"
                  style={{ maxWidth: "100%", height: "100%" }}
                  alt=""
                />
              </NavLink>
            ...
            <SwiperSlide>
              <NavLink to={"/shop"}>
                <img
                  src="https://www.tanishq.co.in/dw/image/v2/BKCK_PRD/on/demandware.static/-/Library-Sites-TanishqSharedLibrary/default/dwec8b6214/homepage/HeroBanner/engrings-wo-desktop.jpg"
                  style={{ maxWidth: "100%", height: "100%" }}
                  alt=""
                />
              </NavLink>
                ...
                <div className="row">
                  <div className="col-lg-3 col-sm-6 col-12">
                    ...
                    >
                      <div className="image">
                        <img
                          src="assets/images/icons/service-promo-1.png"
                          alt=""
                        />
                      </div>
                  ...
                  <div className="col-lg-3 col-sm-6 col-12">
                    ...
                    >
                      <div className="image">
                        <img
                          src="assets/images/icons/service-promo-2.png"
                          alt=""
                        />
                      </div>
                      <div className="content">
                  ...
                  <div className="col-lg-3 col-sm-6 col-12">
                    ...
                    >
                      <div className="image">
                        <img
                          src="assets/images/icons/service-promo-3.png"
                          alt=""
                        />
                      </div>
                      <div className="content">
                  ...
                  <div className="col-lg-3 col-sm-6 col-12">
                    ...
                    >
                      <div className="image">
                        <img
                          src="assets/images/icons/service-promo-4.png"
                          alt=""
                        />
                      </div>
                      <div className="content">
                        ...
                        <p>
                          Card for the other 30% of their purchases at a rate of
                          1% cash back.
                        </p>
                      </div>
                    </div>
            ...
            <div className="banner-wrapper">
              <div className="container-fluid">
                <div className="row mb-n6">
                  <div className="col-lg-6 col-12 mb-6">
                    ...
                    >
                      <div className="image">
                        <img
                          src="https://www.titan.co.in/on/demandware.static/-/Library-Sites-TitanSharedLibrary/default/dw1b22c6a6/images/MechanicalE.jpg"
                          alt=""
                          style={{ height: "700px", borderRadius: "10%" }}
                        />
                      </div>
                      <div className="content">
                ...
                <h5 className="sub-title">We design your home</h5> */}
                        <NavLink
                          to="/category/63fb2a4951915d055dc7446d"
                    ...
                    <div className="row mb-n6">
                      <div className="col-lg-6 col-sm-6 mb-6">
                        ...
                        >
                          <div className="image">
                            <img
                              src="https://rukminim2.flixcart.com/image/832/832/kxjav0w0/ring/n/a/i/adjustable-1-z61-ring-rspr-original-imag9ypdxgdwheyf.jpeg?q=70"
                              alt=""
                        ...
                        <a href="product-details-default.html" className="link-text"><span>Shop
                                now</span></a> */}
                            <NavLink
                              to="/category/63fb2ab951915d055dc746aa"
                              className="btn btn-lg btn-outline-golden icon-space-left"
                            >
                              <span className="d-flex align-items-center">
                                discover now{" "}
                      ...
                      <div className="col-lg-6 col-sm-6 mb-6">
                        ...
                        >
                          <div className="image">
                            <img
                              src="https://rukminim2.flixcart.com/image/832/832/xif0q/perfume/f/l/l/-original-imagqe28rzj9ymbz.jpeg?q=70"
                        ...
                        <a href="product-details-default.html" className="link-text"><span>Shop
                                now</span></a> */}
                            <NavLink
                              to="/category/63fb2a7f51915d055dc745da"
                              className="btn btn-lg btn-outline-golden icon-space-left"
                            >
                              <span className="d-flex align-items-center">
                                discover now{" "}
                      ...
                      <div className="col-lg-6 col-sm-6 mb-6">
                        ...
                        >
                          <div className="image">
                            <img
                              src="https://rukminim2.flixcart.com/image/832/832/xif0q/wallet-card-wallet/3/w/h/-original-imagqwxn5uyg6s6f.jpeg?q=70"
                              style={{ borderRadius: "10%" }}
                              alt=""
                            />
                          </div>
                        ...
                        <a href="product-details-default.html" className="link-text"><span>Shop
                                now</span></a> */}
                            <NavLink
                              to="/category/63fb2a8f51915d055dc74626"
                              className="btn btn-lg btn-outline-golden icon-space-left"
                            >
                              <span className="d-flex align-items-center">
                                discover now{" "}
                      ...
                      <div className="col-lg-6 col-sm-6 mb-6">
                        ...
                        >
                          <div className="image">
                            <img
                              src="https://assets.ajio.com/medias/sys_master/root/20230628/mrX2/649b5082eebac147fc0f60ae/-473Wx593H-465601331-black-MODEL.jpg"
                              style={{ borderRadius: "10%" }}
                              alt=""
                            />
                          </div>
                        ...
                        <a href="product-details-default.html"><span>Shop now</span></a> */}
                            <NavLink
                              to="/category/63fb2a5751915d055dc744a9"
                              className="btn btn-lg btn-outline-golden icon-space-left"
                            >
                              <span className="d-flex align-items-center">
                                discover now{" "}
